...
export function PlaneTakeoffIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 22h20" />
      <path d="M6.36 17.4L4 17l-2-4 1.1-.55a2 2 0 011.8 0l.17.1a2 2 0 001.8 0L8 12 5 6l1.1-.55a2 2 0 011.8 0l.17.1a2 2 0 001.8 0L12 4l1.5 6 2.5-1.5L22 5l-2 7-12.5 5.5" />
    </svg>
  )
}
...
export function MessageCircleIcon({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
